...
type App struct {
	*baseapp.BaseApp
	...
	TvoteKeeper tvotemodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.TvoteKeeper = *tvotemodulekeeper.NewKeeper(
		appCodec,
		keys[tvotemoduletypes.StoreKey],
		keys[tvotemoduletypes.MemStoreKey],
		app.GetSubspace(tvotemoduletypes.ModuleName),
	)
	tvoteModule := tvotemodule.NewAppModule(appCodec, app.TvoteKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(tvotemoduletypes.ModuleName)
